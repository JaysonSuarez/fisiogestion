...
import { Home, CalendarPlus, CalendarDays, User, FileText } from 'lucide-react'
...
export default function PatientBottomNav() {
  ...
  if (
    ...
    pathname.includes('/cambiar-clave')
  ) {
    return null
  }
  ...
  return (
    <nav className="fixed bottom-0 w-full max-w-md bg-white/90 backdrop-blur-xl border-t border-rose-100 shadow-[0_-10px_40px_-15px_rgba(225,29,72,0.1)] z-50">
      <div className="max-w-md mx-auto px-3 h-20 flex items-center justify-between">
        ...
        <NavItem href="/app/documentos" icon={<FileText size={24} />} label="Documentos" currentPath={pathname} />
